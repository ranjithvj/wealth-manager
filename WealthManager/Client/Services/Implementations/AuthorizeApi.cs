...
namespace WealthManager.Client.Services.Implementations
{
    public class AuthorizeApi : IAuthorizeApi
    {
        ...
        public async Task Login(UserLoginVM loginParameters)
        {
        ...
        public async Task Register(UserRegisterVM registerParameters)
        {
        ...
        public async Task<UserAuthInfoVM> GetUserInfo()
        {
            var result = await _httpClient.GetFromJsonAsync<UserAuthInfoVM>("api/Authorize/UserInfo");
            return result;
        }
    }
}
